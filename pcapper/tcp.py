...
class TcpSummary:
    ...
    session_integrity_profiles: list[dict[str, object]] = field(default_factory=list)
    recon_profiles: list[dict[str, object]] = field(default_factory=list)
    teardown_profiles: list[dict[str, object]] = field(default_factory=list)
    ...
    egress_outlier_profiles: list[dict[str, object]] = field(default_factory=list)
